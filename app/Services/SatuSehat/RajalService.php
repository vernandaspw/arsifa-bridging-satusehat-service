...
class RajalService
{
    ...
    public static function rajalBundle(array $body)
    {
        try {
            ...
            $patient_nama = $body['patient_name'];
            ...
            $bodyRaw = RajalService::rajalBundleBody(
                $noreg,
                $reg_tgl,
                $discharge_tgl,
                $location_ihs,
    ...
    // public static function encounterKunjunganBaruBody($noreg,
    // $reg_tgl,
    // $location_id,
    // $location_name,
    // $patient_id,
    ...
    //         $bodyRaw = RajalService::encounterKunjunganBaruBody(
    //             $noreg,
    //             $reg_tgl,
    //             $discharge_tgl,
